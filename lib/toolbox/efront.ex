defmodule Toolbox.Efront do
  ...
  FROM [GLENTRY] A
    LEFT JOIN [VCINVESTMENTINS] R1 ON R1.IQID=A.KEYID4
    LEFT JOIN [VCINVESTMENT] R2 ON R2.IQID=R1.INVESTMENT
    LEFT JOIN [SFAACCOUNT] R3 ON R3.IQID=R2.FIRM
    LEFT JOIN [VCFUND] R4 ON R4.IQID=R2.FUND
    LEFT JOIN [SFAACCOUNT] R5 ON R5.IQID=R2.ACCOUNT
    LEFT JOIN [GLACCOUNT] R6 ON R6.IQID=A.ACCOUNT
    LEFT JOIN [VCINVESTMENTOP] R7 ON R7.IQID=A.KEYID3
  ...
  FROM GLENTRY A
  LEFT JOIN VCINVESTMENTINS R1 ON R1.IQID=A.KEYID4
  LEFT JOIN VCINVESTMENTOP R2 ON R2.IQID=A.KEYID3
  LEFT JOIN VCINVESTMENT R3 ON R3.IQID=R2.INVESTMENT
  LEFT JOIN VCFUND R4 ON R4.IQID=R3.FUND
  LEFT JOIN SFAACCOUNT R5 ON R5.IQID=R3.ACCOUNT
  LEFT JOIN GLACCOUNT R6 ON R6.IQID=A.ACCOUNT
