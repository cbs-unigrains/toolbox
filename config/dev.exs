...
config :toolbox, Toolbox.Repo,
  username: System.get_env("TOOLBOX_REPO_USERNAME"),
  password: System.get_env("TOOLBOX_REPO_PASSWORD"),
  hostname: "srv-sgbd",
  database: "Chrono",
  stacktrace: true,
  show_sensitive_data_on_connection_error: true,
...
config :toolbox, ToolboxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0v5bu9rQJxbD9P5L9tXwe+dwnubDVHecsaE2KXamzuBAMGqPHvRi8d99ezuazziX",
  watchers: [
